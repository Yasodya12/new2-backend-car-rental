export const baseTemplate = (content: string, title: string = "Transport Service") => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
export const bookingConfirmationTemplate = (customerName: string, tripId: string) => {
    const content = `
...
export const tripAssignmentTemplate = (
    driverName: string,
    tripId: string,
    ...
    return baseTemplate(content, "New Trip Assignment");
};

export const passwordResetTemplate = (resetToken: string) => {
...
export const adminNotificationTemplate = (subject: string, message: string) => {
    ...
    return baseTemplate(content, `Admin Alert: ${subject}`);
};

export const loginNotificationTemplate = (message: string, userAgent?: string, ipAddress?: string) => {
    const content = `
...
export const otpEmailTemplate = (otp: string, userName?: string) => {
    ...
    return baseTemplate(content, "Password Reset OTP");
};

export const tripAcceptedTemplate = (
    customerName: string,
    tripId: string,
    driverName: string,
    vehicleBrand: string,
    ...
    return baseTemplate(content, "Trip Accepted");
};

export const tripCancelledTemplate = (
    customerName: string,
    tripId: string,
    startLocation: string,
    endLocation: string,
    ...
    return baseTemplate(content, "Trip Cancelled / Declined");
};

export const tripCompletedTemplate = (
    customerName: string,
    tripId: string,
    price: number,
    startLocation: string,
    ...
    return baseTemplate(content, "Trip Bill");
};
...
export const paymentReceiptTemplate = (
    ...
    return baseTemplate(content, "Payment Receipt");
};

export const adminCredentialsTemplate = (name: string, email: string, password: string) => {
    const content = `
    ...
    return baseTemplate(content, "New Administrator Credentials");
};
